...
This document tracks incidents where the AI agent made mistakes that required manual intervention or correction.

---

## Incident: node_modules Committed to Git History
